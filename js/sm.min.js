...
$.smVersion = "0.5.4", +function (a) {
    ...
    ["width", "height"].forEach(function (b) {
        ...
        if (b) {
            var c = {};
            if (b.dataset)for (var d in b.dataset)c[d] = b.dataset[d]; else for (var e = 0; e < b.attributes.length; e++) {
    ...
    a.modalStack = [], a.modalStackClearQueue = function () {
        ...
        var h = b.title ? '<div class="modal-title">' + b.title + "</div>" : "", i = b.text ? '<div class="modal-text">' + b.text + "</div>" : "", j = b.afterText ? b.afterText : "", k = b.buttons && 0 !== b.buttons.length ? "" : "modal-no-buttons", l = b.verticalButtons ? "modal-buttons-vertical" : "";
        ...
        return a.modal({title: b || d.modalPreloaderTitle, text: '<div class="preloader"></div>'})
        ...
        var f = b.hasClass("popup"), g = b.hasClass("login-screen"), h = b.hasClass("picker-modal"), i = b.hasClass("toast");
        e && (b.show(), b.css({marginTop: -Math.round(b.outerHeight() / 2) + "px"})), i && b.css({marginLeft: -Math.round(b.outerWidth() / 2 / 1.185) + "px"});
        var j;
    ...
    var b = !1, c = function (c) {
        ...
        function e(a) {
            if (a.preventDefault(), !h.opened && (h.open(), h.params.scrollToInput)) {
                ...
                var c, d = parseInt(b.css("padding-top"), 10), e = parseInt(b.css("padding-bottom"), 10), f = b[0].offsetHeight - d - h.container.height(), g = b[0].scrollHeight - d - h.container.height(), i = h.input.offset().top - d + h.input[0].offsetHeight;
                if (i > f) {
                    var j = b.scrollTop() + i - f;
                    j + f > g && (c = j + f - g + e, f === g && (c = h.container.height()), b.css({"padding-bottom": c + "px"})), b.scrollTop(j, 300)
                }
            }
        }
        ...
        function g() {
            h.opened = !1, h.input && h.input.length > 0 && h.input.parents(".page-content").css({"padding-bottom": ""}), h.params.onClose && h.params.onClose(h), h.destroyCalendarEvents()
        }
    ...
    var b = function (b) {
        ...
        function d(a) {
            if (a.preventDefault(), !g.opened && (g.open(), g.params.scrollToInput)) {
                ...
                if (0 === b.length)return;
                var c, d = parseInt(b.css("padding-top"), 10), e = parseInt(b.css("padding-bottom"), 10), f = b[0].offsetHeight - d - g.container.height(), h = b[0].scrollHeight - d - g.container.height(), i = g.input.offset().top - d + g.input[0].offsetHeight;
                if (i > f) {
                    var j = b.scrollTop() + i - f;
                    j + f > h && (c = j + f - h + e, f === h && (c = g.container.height()), b.css({"padding-bottom": c + "px"})), b.scrollTop(j, 300)
                }
            }
        }
        ...
        function f() {
            g.opened = !1, g.input && g.input.length > 0 && g.input.parents(".page-content").css({"padding-bottom": ""}), g.params.onClose && g.params.onClose(g), g.container.find(".picker-items-col").each(function () {
    ...
    var c = function (a, b) {
        ...
        return 1
    }, d = {scrollTop: a.fn.scrollTop, scrollLeft: a.fn.scrollLeft};
    !function () {
        a.extend(a.fn, {
    ...
    var e = function (b, d) {
        ...
        var f = this.options.type, g = "js" === f || "auto" === f && a.os.android && c("4.4.0", a.os.version) > -1 || a.os.ios && c("6.0.0", a.os.version) > -1;
        if (g) {
            ...
            var j = a(b).hasClass("pull-to-refresh-content"), k = {probeType: 1, mouseWheel: !0};
    ...
    b.prototype.defaults = {}, b.prototype.init = function () {
        var b = this.getCurrentPage(), c = a(".page").eq(0);
        ...
        var f = this.genStateID(), g = location.href, h = g.split("#")[0];
        history.replaceState({url: g, id: f}, "", g), this.setCurrentStateID(f), this.pushBack({
            url: h,
            pageid: "#" + c[0].id,
            id: f
        ...
        this.newLoaded && (this.newLoaded = !1), this.getPage(b, function (c) {
            ...
            this.pushBack({url: b, pageid: "#" + d, id: this.getCurrentStateID()});
        ...
        var c = this.popBack(), d = this.getCurrentPage(), e = a(c.pageid);
        ...
        var b = this.popForward(), c = this.getCurrentPage(), d = a(b.pageid);
        d[0] && (this.pushBack({
            url: location.href,
            pageid: "#" + c[0].id,
            id: this.getCurrentStateID()
        ...
        this.dispatch("pageLoadStart"), this.xhr && this.xhr.readyState < 4 && (this.xhr.onreadystatechange = function () {
        }, this.xhr.abort(), this.dispatch("pageLoadCancel"));
        var d = this;
        this.xhr = a.ajax({
            url: b, success: a.proxy(function (a, b, d) {
        ...
        var c = b.responseText, d = c.match(/<body[^>]*>([\s\S.]*)<\/body>/i)[1];
        d || (d = c), d = "<div>" + d + "</div>";
        var e = a(d);
